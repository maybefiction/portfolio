...
const SITE_CONTENT = {
  ...
  experiences: [
    ...
    },
    {
      ...
      fullSynopsis: [
        "We redesigned three floors of the Brooklyn Peace Center into a single, unfolding experience that combined gathering, contemporary dance, live music, and participatory installations. Rather than asking audiences to simply attend a performance, we invited them to move together through a sequence of shared rituals, treating the moments before, between, and after each dance work as carefully as the performances themselves.",
        "Meaningful attachments rarely happen when we're actively seeking them. They form in the cracks and crevices of daily life: building rapport with a neighbor through repeated hallway run-ins, understanding yourself by processing lingering thoughts on a walk to work, or feeling connected to a place by noticing the trees that line a familiar route. As more of our needs are met remotely, and as we learn to move efficiently through the world instead of attentively through it, we accidentally curate away many of the small frictions and shared contexts through which intimacy emerges and deepens. Our days become so streamlined that we skim past the moments that once grounded us — arriving just in time, leaving as soon as we're done.",
        "The evening centered on two contemporary dance works exploring ritual, repetition, intimacy, and attachment. Surrounding them were two participatory environments that prepared audiences for each transition. On the first floor, visitors gathered around a fire installation to make bracelets and necklaces, sharing space with strangers without the expectation of conversation. On the third floor, participants walked together around a pond installation before tossing small one-inch mirror tokens into the water, creating a simple collective ritual before returning to the final performance.",
        "We wanted to suggest that experiences do not begin when the lights go down or end when they come back up. By moving everyone together across three floors, the evening blurred the boundary between the artwork and everything surrounding it. Slowing down and approaching the moments before, between, and after an artwork with greater intention and celebration deepens both the artwork itself and the relationships that form around it.",
      ],
